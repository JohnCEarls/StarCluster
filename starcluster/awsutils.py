...
class EasyAWS(object):
    def __init__(self, aws_access_key_id, aws_secret_access_key,
        ...
        """
        self.aws_access_key_id = None # aws_access_key_id
        self.aws_secret_access_key = None # aws_secret_access_key
    ...
    def conn(self):
        if self._conn is None:
            ...
            self._conn = self.connection_authenticator( self.aws_access_key_id,
